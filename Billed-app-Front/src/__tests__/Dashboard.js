...
describe('Given I am connected as an Admin', () => {
  ...
  describe('When I am on Dashboard page and I click on arrow', () => {
    test('Then, tickets list should be unfolding, and cards should appear', async () => {
      ...
      const handleShowTickets1 = jest.fn((e) => dashboard.handleShowTickets(e, bills, 1, '#arrow-icon1'))
      const handleShowTickets2 = jest.fn((e) => dashboard.handleShowTickets(e, bills, 2, '#arrow-icon2'))
      const handleShowTickets3 = jest.fn((e) => dashboard.handleShowTickets(e, bills, 3, '#arrow-icon3'))
